...
CREATE TABLE "cm_car_price" (
    ...
    CONSTRAINT "cm_car_price_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "sys_user_session_session_id_key" ON "sys_user_session"("session_id");

-- CreateIndex
CREATE INDEX "sys_user_session_user_id_idx" ON "sys_user_session"("user_id");

-- CreateIndex
CREATE INDEX "sys_user_session_session_id_idx" ON "sys_user_session"("session_id");
...
-- AddForeignKey
ALTER TABLE "sys_user_session" ADD CONSTRAINT "sys_user_session_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "sys_user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "cm_car_price" ADD CONSTRAINT "cm_car_price_car_id_fkey" FOREIGN KEY ("car_id") REFERENCES "cm_car"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
